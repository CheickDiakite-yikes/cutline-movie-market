...
- An unmodeled live market must read as an intentional market-only state. Say that its poster or research pack is not built; never label work as queued unless a real automation has queued it, and never replace unavailable historical scores with invented values.
